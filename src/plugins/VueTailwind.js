...
const settings = {
  ...
  't-button': {
    ...
    props: {
      ...
      variants: {
        secondary: 'text-blue-600 bg-white border border-blue-500 rounded shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none focus:ring-opacity-50 hover:bg-gray-50',
